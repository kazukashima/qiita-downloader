...
//   .qiita-preview {
//     width: 180mm; /* 190mmより少し余裕を持たせると安全 */
//     margin: 0 auto;
//     padding: 20px 0;
...
//   /* 【重要】文字の下が切れるのを防ぐ設定 */
//   p, li, h1, h2, h3, h4, blockquote, pre, table {
//     page-break-inside: avoid; /* 旧仕様 */
//     break-inside: avoid;      /* 新仕様 */
//     position: relative;       /* 描画ズレ防止 */
//   }
...
// </head>
// <body>
//   <div class="qiita-preview">${html}</div>
// </body>
// </html>
//     `);
//     doc.close();

//     await new Promise((r) => setTimeout(r, 500)); // 描画待ちを少し伸ばす

//     const opt = {
//       filename: `${title}.pdf`,
//       margin: [15, 10, 15, 10], // 上下左右にマージンを設定
//       html2canvas: {
//         scale: 2, // 1.5から2に上げると文字の判定精度が上がる
//         useCORS: true,
//         letterRendering: true, // 文字の切れ対策
//       },
...
//         <button onClick={toggleAll} className="flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-indigo-600">
...
//               className={`p-4 cursor-pointer hover:bg-gray-50 ${selectedIds.includes(article.id) ? "bg-indigo-50" : ""}`}
//             >
...
//                   <h3 className="text-gray-800 font-medium mb-1">{article.title}</h3>
//                   <div className="flex gap-3 text-xs font-medium">
//                     <button
//                       onClick={(e) => { e.stopPropagation(); handleDownload(article.title, article.body); }}
//                       className="text-indigo-600 hover:text-indigo-700"
//                     > .md </button>
//                     <button
//                       onClick={(e) => { e.stopPropagation(); handlePdfDownload(article.title, article.body); }}
